...
public static class hl2ss
{
    ...
    [DllImport("hl2ss")]
    private static extern void MQ_SO_Push(uint value, float[] model_transform);
    [DllImport("hl2ss")]
    ...
    private static void MQ_SO_Push(uint value, float[] model_transform)
    {
    }
    ...
    public static void PushResult(uint value, float[] model_transform)
    {
        MQ_SO_Push(value, model_transform);
    }
